...
router.get('/client-draft', requirePermission('informes', 'view'), reportController.clientReportDraft);
router.post('/client-pdf', requirePermission('informes', 'view'), reportController.clientReportPdf);
