...
router.post('/', requirePermission('cotizaciones', 'create'), preventDuplicateSubmit, apuController.create);
...
router.post('/:id/components', requirePermission('cotizaciones', 'edit'), preventDuplicateSubmit, apuController.addComponent);
