...
## 3. Antes de compilar para las tiendas (una sola vez)
...
## 4. EAS Build (genera el .apk/.aab y el .ipa)

```bash
cd mobile
eas build:configure          # solo la primera vez: crea/confirma el project id de Expo
eas build --platform android --profile preview     # .apk para probar en un celular sin Play Store
...
## 5. EAS Submit (envío a cada tienda)
...
## 6. Cómo funciona el modo sin conexión
