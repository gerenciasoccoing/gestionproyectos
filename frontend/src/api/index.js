...
export const budgetApi = {
  ...
  scanItemApu: (pid, formData) => client.post(`/projects/${pid}/budget/scan-item-apu`, formData).then((r) => r.data),
  addItemsWithApu: (pid, budgetId, entries) => client.post(`/projects/${pid}/budget/${budgetId}/items/with-apu`, { entries }).then((r) => r.data),
  updateItem: (pid, budgetId, itemId, data) => client.put(`/projects/${pid}/budget/${budgetId}/items/${itemId}`, data).then((r) => r.data),
  getItemApuDetail: (pid, budgetId, itemId) => client.get(`/projects/${pid}/budget/${budgetId}/items/${itemId}/apu-detail`).then((r) => r.data),
